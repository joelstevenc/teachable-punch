...
let colors = ['#36b33a', '#e60101', '#794AEF', '#1291D0'];//#E67701#D84C6F
let lightColors = ['#e6fce6', '#ffe2e2', '#F1F0FF', '#E2F5FF'];//#FFECE2#FFE9EC
...
function makeBar(label, index) {
    ...
    //let graphWrapper2 = document.getElementById('graph-wrapper2');
    //graphWrapper2.appendChild(barWrapper);
